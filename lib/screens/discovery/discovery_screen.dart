...
class _DiscoveryScreenState extends State<DiscoveryScreen>
  ...
  Widget _buildTrendingList() {
    final trendingRecipes = [
      _TrendingRecipe('Avocado Toast Variations', '2.3k views', Icons.trending_up, AppColors.accent),
      _TrendingRecipe('One-Pot Pasta Recipes', '1.8k views', Icons.trending_up, AppColors.accent),
      _TrendingRecipe('Healthy Smoothie Bowls', '1.5k views', Icons.trending_up, AppColors.accent),
      _TrendingRecipe('Air Fryer Vegetables', '1.2k views', Icons.trending_up, AppColors.accent),
    ];
